 ...
 * O objetivo dessa classe é manter todos os comandos e métodos auxiliares para rápida importação, sugerindo que a importação seja estática dos métodos para mais clareza do código.
 *
...
public class Terminal {
  ...
  /**
   * Acumulador de texto parcial escrito na linha, utilizado por exemplo pelo comando {@link #writePart(String)}.<br>
   * Deve ser reiniciado em zero por todos os métodos que quebrarem a linha e somado por todos que escrevem parcialmente na linha.
   */
   ...
   * Pode ser utilizado para limpar o restante da linha quando estamos sobreescrevendo algum conteúdo, ou para forçar o preenchimento com a cor de fundo em todo o restante da linha, independente do tamanho do terminal.
   */
   ...
   * Define o tamanho padrão do terminal para quando não for possível obter o tamanho correto do terminal.<br>
   *
   * @return o tamanho padrão do terminal para quando não for possível obter o tamanho correto do terminal
   */
   ...
   * Define o tamanho padrão do terminal para quando não for possível obter o tamanho correto do terminal.<br>
   *
   * @param terminalDefaultColumns o novo tamanho padrão do terminal para quando não for possível obter o tamanho correto do terminal
   */
  ...
  /**
   * Simplesmente faz a impressão no console, mas acrescenta o código {@link #ASCII_CLEAR_REMAINING_LINE} para garantir a cor até o final do console.
   *
   * @param text
   */
