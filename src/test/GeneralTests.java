...
/**
 * Description: Classe utilizada para alguns testes locais pelo desenvolvedor, não faz parte do teste unitário.<br>
 *
...
public class GeneralTests {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.print("Aqui limpamos até o fim da linha.");
    emptyLine();
    emptyLine();
